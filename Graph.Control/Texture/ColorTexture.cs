...
namespace Graph.Control.Texture {
	public class ColorTexture : BaseTexture {
		...
		public override Texture2D GetTexture(Rectangle rectangle) {
			return GraphicsHelper.CreateColorTexture(GameManager.GraphicsDeviceManager.GraphicsDevice, rectangle.Width + rectangle.Y, rectangle.Height + rectangle.X, Color);
		}
	}
}
